...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from NINDS2 dataset and check those SNPs quality for getting the accuracy on NINDS2 after adding LD:")    
    
    # reading most common SNPs
    SNPsList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach0/Part_B/NINDS2/CV/mostCommonSNPs.txt', 'r')
    for line1 in f1:
    ...
    LDList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach0/Part_B/NINDS2/CV/SNPsInLDWithMostCommonSNPs.txt', 'r')
    for line1 in f1:
