...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from Autopsy dataset and check those SNPs quality for getting the accuracy on Autopsy after adding LD:")    
    
    # reading most common SNPs
    SNPsList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach0/Part_B/Autopsy/CV/mostCommonSNPs.txt', 'r')
    for line1 in f1:
    ...
    LDList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach0/Part_B/Autopsy/CV/SNPsInLDWithMostCommonSNPs.txt', 'r')
    for line1 in f1:
