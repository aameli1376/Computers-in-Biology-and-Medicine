...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from merged version of (Familial and Autopsy) dataset and check those SNPs quality for getting the accuracy after adding LD - both datasets are balanced:")    
    
    # reading most common SNPs
    SNPsList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach4/Part_B/FamilyAndAutopsy/CV/mostCommon.txt', 'r')
    for line1 in f1:
    ...
    LDList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach4/Part_B/FamilyAndAutopsy/CV/mostCommonAndLD.txt', 'r')
    for line1 in f1:
