...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from merged version of (Familial and Autopsy) dataset and check those SNPs quality for getting the accuracy - Both datasets are balanced:")    
    ...
    print("Reading FamilyAutopsy(MergedAndBalancedWithID).csv ...")
    df= pd.read_csv(path + "FamilyAutopsy(MergedAndBalancedWithID).csv")
