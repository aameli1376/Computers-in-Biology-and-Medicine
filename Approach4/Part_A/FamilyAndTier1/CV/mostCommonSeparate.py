...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from merged version of (Familial and Tier1) dataset and check those SNPs quality for getting the accuracy - Both datasets are balanced:")    
    
    # reading most common SNPs
    SNPsList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach4/Part_A/FamilyAndTier1/CV/mostCommon.txt', 'r')
    for line1 in f1:
    ...
    print("Reading FamilyTier1(MergedAndBalancedWithID).csv ...")
    df= pd.read_csv(path + "FamilyTier1(MergedAndBalancedWithID).csv")
