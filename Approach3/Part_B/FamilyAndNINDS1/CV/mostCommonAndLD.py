...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from merged version of (Familial and NINDS1) dataset and check those SNPs quality for getting the accuracy after adding LD:")    

    
    # reading most common SNPs
    SNPsList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach3/Part_B/FamilyAndNINDS1/CV/mostCommonSNPs.txt', 'r')
    for line1 in f1:
    ...
    LDList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach3/Part_B/FamilyAndNINDS1/CV/SNPsInLDWithMostCommonSNPs.txt', 'r')
    for line1 in f1:
    ...
    print("Reading FamilyNINDS1(Merged).csv ...")
    df= pd.read_csv(path + "FamilyNINDS1(Merged).csv")
