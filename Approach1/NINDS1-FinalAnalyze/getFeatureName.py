...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from Familial dataset and check those SNPs quality for getting the accuracy on NINDS1 dataset before adding SNPs in LD")     
    ...
    path = '/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach1/NINDS1-FinalAnalyze/'
