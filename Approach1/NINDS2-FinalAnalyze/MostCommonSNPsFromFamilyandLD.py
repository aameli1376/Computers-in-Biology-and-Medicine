...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from Familial dataset and check those SNPs quality for getting the accuracy on NINDS2 dataset after adding SNPs in LD")
    ...
    LDList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach1/NINDS2-FinalAnalyze/SNPsinLDwithmostcommonSNPs.txt', 'r')
    for line1 in f1:
    ...
    df= pd.read_csv("PD_2_NINDS_28Jan2022.csv")
