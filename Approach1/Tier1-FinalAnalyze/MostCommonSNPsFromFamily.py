...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from Familial dataset and check those SNPs quality for getting the accuracy on Tier1 dataset before adding SNPs in LD")    
