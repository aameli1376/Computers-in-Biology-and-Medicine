...
if __name__ == "__main__":
    ...
    print("Select the most common SNPs from Familial dataset and check those SNPs quality for getting the accuracy on Tier1 dataset after adding SNPs in LD")
    ...
    path = '/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach1/Tier1-FinalAnalyze/'
    ...
    LDList = []    
    f1 = open('/scratch/fs2/usefi/pd/datasets/All_Aproaches/Approach1/Tier1-FinalAnalyze/SNPsinLDwithmostcommonSNPs.txt', 'r')
    for line1 in f1:
